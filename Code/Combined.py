        ...
        for a2 in agents:
            ...
            for row2 in all_data:
                if ((row2[0] == a2) and (row2[1] == g)):
                    a2_data = row2
            val = (a1_data[3] - a2_data[3])*(a1_data[3] - a2_data[3])
            val = val / (2*((a1_data[6] + a2_data[6])*(a1_data[6] + a2_data[6])))

            val2 = (a1_data[4] - a2_data[4])*(a1_data[4] - a2_data[4])
            val2 = val2 / (2*((a1_data[7] + a2_data[7])*(a1_data[7] + a2_data[7])))
            ...
            val3 = (math.sqrt((2*math.pi)*((a1_data[6] + a2_data[6])*(a1_data[6] + a2_data[6]))))
            val4 = (math.sqrt((2*math.pi)*((a1_data[7] + a2_data[7])*(a1_data[7] + a2_data[7]))))
